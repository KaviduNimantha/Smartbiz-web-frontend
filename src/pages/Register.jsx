                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <BusinessOutlined sx={{ color: 'rgba(255,255,255,0.6)' }} />
                    </InputAdornment>
                  ),
                }}
                sx={inputSx}
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <PersonOutlined sx={{ color: 'rgba(255,255,255,0.6)' }} />
                    </InputAdornment>
                  ),
                }}
                sx={inputSx}
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                InputProps={{
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton onClick={() => setShowConfirmPassword((v) => !v)} edge="end" sx={{ color: 'rgba(255,255,255,0.6)' }}>
...
// Shared MUI TextField overrides for glassmorphism style
const inputSx = {
